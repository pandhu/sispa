	...
	<div class="modal fade akun-add" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<form  class="form-horizontal" style="margin:20px" method="POST" action="<?php echo base_url()?>akun_master/add">
					...
					<div class="form-group">
						<label for="kode" class="col-sm-2 control-label">Event </label>
						<div class="col-sm-10">
							<select class="form-control" name="event_id">
							<?php 
							foreach ($event as $ee) { ?>
								<option value="<?php echo $ee->id_event ?>"><?php echo $ee->description?></option>
							<?php
							} //foreach
							?>	
							</select>
	...
	<div class="modal fade akun-delete" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					...
					<form  class="form-horizontal" style="margin:20px" method="POST" action="<?php echo base_url()?>akun_master/delete">
